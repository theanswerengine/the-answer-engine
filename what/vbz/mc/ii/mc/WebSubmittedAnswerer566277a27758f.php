...
class WebSubmittedAnswerer566277a27758f implements Answerer {
    ...
    public static function answer_question(array $question) {
        /*
          ...
          Author's original question: 'what is two plus two?'

          Comments:

should be easy to check for certain values of general preposition sandwiched between cardinal numbers and just do the computation. 
